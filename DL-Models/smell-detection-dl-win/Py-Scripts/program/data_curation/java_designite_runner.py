...
def _run_designite_java(folder_name, folder_path, designiteJava_jar_path, smells_results_folder):
   ...
   # proc = Popen(["C:/Users/author/.jdks/openjdk-18.0.2.1/bin/java", "-jar", designiteJava_jar_path, "-i", folder_path, "-o", out_folder])
    proc.wait()
...
def _build_project(dir, dir_path):
    ...
    if os.path.exists(pom_path):
        ...
        #my_env["JAVA_HOME"] = "C:/Users/author/.jdks/openjdk-18.0.2.1"
    ...
    if os.path.exists(gradle_path):
        ...
        #proc = Popen(['C:/Users/author/Documents/gradle-6/gradle-6.0/bin', 'build','-x','test'],shell=True,env=my_env)
        proc.wait()
        is_compiled = True
    if not is_compiled:
